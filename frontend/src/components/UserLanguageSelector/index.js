...
import { Globe } from "lucide-react"; // Importando o ícone da biblioteca Lucide
    ...
    return (
        <>
            <Button
                ...
                startIcon={
                    <Globe style={{ color: "#64748b", transform: "scale(0.9)", marginLeft: "10px" }} />
                } // Adicionado estilo ao ícone
            >
            </Button>
            <Menu
                ...
                PaperProps={{
                    style: { marginTop: "40px", backgroundColor:"#576784" }, // Ajustando a margem superior do menu
                }}
            >

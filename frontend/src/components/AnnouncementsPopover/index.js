...
import { Info } from "lucide-react";  // Importando o ícone de informação
...
export default function AnnouncementsPopover() {
  ...
  return (
    <div>
      ...
      <IconButton
          variant="contained"
          style={{color: "#64748b", transform: "scale(0.8)"}} // Cor do ícone como azul, mais sutil
          aria-describedby={id}
          onClick={handleClick}
        >
          <Badge
          ...
          >
            <Info />  {/* Ícone de informação substituído */}
          </Badge>
        </IconButton>

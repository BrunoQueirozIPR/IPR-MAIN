  ...
  return (
    ...
    >
      ...
      <DialogActions>
        ...
        >
          <Icons.X color="#FFFFFF" strokeWidth={1.5} size={20} style={{ marginRight: '5px' }} />
          {i18n.t("chatInternal.modal.cancel")}
        </Button>
        <Button onClick={handleSave} color="primary" variant="contained">
          <Icons.Save color="#FFFFFF" strokeWidth={1.5} size={20} style={{ marginRight: '5px' }} />
          ...
          {/* {user.profile === "admin" && ( */}
            <div className={classes.btnContainer}>
              <Button
                ...
                variant="contained"
              >
                <Icons.Plus color="white" strokeWidth={1.5} size={20} style={{ marginRight: '5px' }} />
          ...
          <Grid className={classes.gridItemTab} md={12} item>
            <div className={classes.btnContainer}>
              <Button
                ...
                variant="contained"
              >
                <Icons.Plus color="#cbd5e1" strokeWidth={1.5} size={20} style={{ marginRight: '5px' }} />
                Novo
              </Button>
            </div>
            <ChatList

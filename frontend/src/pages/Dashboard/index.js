...
import { Box, AppBar, Grid, Tabs, Tab } from '@mui/material';
    ...
    <div>
      <Container maxWidth="lg" className={classes.container}>
        <Grid container spacing={3} className={classes.container}>
          ...
          <Box sx={{ borderRadixus: '14px', overflow: 'hidden', width: '100%' }}>
            <AppBar position="static" sx={{ borderRadius: '14px', width: '100%', padding: '10px', paddingLeft: '40px' }}>

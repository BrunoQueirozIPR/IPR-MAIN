...
const IconChannel = (channel) => {
  switch (channel) {
    ...
    case "whatsapp":
      return <MessageCircle style={{ color: "#25d366" }} />;
    default:
      return "error";
  }
};
    ...
    return (
      <div className={classes.customTableCell}>
        {whatsApp.status === "DISCONNECTED" && (
          ...
          >
            <SignalZero size={20} color="#f44336" strokeWidth={1.5} />
          </CustomToolTip>
        )}
        {whatsApp.status === "OPENING" && (
        ...
        {whatsApp.status === "qrcode" && (
          ...
          >
            <QrCode size={20} color="#000000" strokeWidth={1.5} />
          </CustomToolTip>
        )}
        {whatsApp.status === "CONNECTED" && (
          <CustomToolTip title={i18n.t("connections.toolTips.connected.title")}>
            <Signal size={20} color="#4caf50" strokeWidth={1.5} />
          </CustomToolTip>
        )}
        {(whatsApp.status === "TIMEOUT" || whatsApp.status === "PAIRING") && (
          ...
          >
            <SignalLow size={20} color="#f44336" strokeWidth={1.5} />
          </CustomToolTip>
        )}
      </div>
    );
                  ...
                  whatsApps.map((whatsApp) => (
                    <TableRow key={whatsApp.id}>
                      ...
                      <TableCell align="center">
                        {whatsApp.isDefault && (
                          <div className={classes.customTableCell}>
                            <CheckCircle2 size={20} color="#4caf50" strokeWidth={1.5} />
                          </div>
                        )}
                      </TableCell>
                      <TableCell align="center">
                        ...
                        >
                          <PencilLine size={20} color="#FFFFFF" strokeWidth={1.5} />
                        </IconButton>
